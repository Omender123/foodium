...
public final class ItemPostBinding implements ViewBinding {
  ...
  private ItemPostBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
      @NonNull TextView postAuthor, @NonNull TextView postTitle) {
  ...
  public static ItemPostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPostBinding((ConstraintLayout) rootView, imageView, postAuthor, postTitle);
    }
